...
<header id="site-header" class="site-header">
	...
	<div class="topbar py-0">
		<div class="container-fluid p-0">
			<div class="row px-0">
				<div class="col-12">
				<div class="alert alert-warning py-2 px-0 m-0 bg-primary border-0 rounded-0 alert-dismissible fade show text-center overflow-hidden" role="alert">
<!-- SVG shape START -->
...
<div class="position-relative">
	<p class="text-white m-0">Unlimited download! Starting from just $15/m <a href="#" class="btn btn-xs btn-dark ms-3 mb-0 border-0">Grab now!</a></p>
</div>
<!-- Close button -->
<button type="button" class="btn-close btn-close-white opacity-9 p-3" data-bs-dismiss="alert" aria-label="Close"></button>
					...
					<!-- <?php
									...
									wp_nav_menu( array(
										...
										'container'         => 'div',
										'menu_class'        => 'top-nav',
										'fallback_cb'       => 'blogzine_bootstrap_navwalker::fallback',
										'walker'            => new blogzine_bootstrap_navwalker()
									));
								else: ?>
								<ul id="menu-main" class="top-nav">
					...
					<div class="main-menu">
						<nav class="nav">
							<?php
								...
								<ul id="menu-top-1" class="nav menu">
									<?php wp_nav_menu()  ?>
									<!-- <?php wp_list_pages( array( 'title_li' => '','depth' =>1 ) ); ?> -->
								</ul>
								<?php  endif; ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
	...
	<!-- End Middle Header -->
		...
		<div class="col-12 bg-info bg-opacity-10 p-2 rounded">
		<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
<div class="carousel-inner">
<div class="carousel-item active">
<span class="badge bg-primary">Trending:</span>
<a href="#" class="text-light text-decoration-none">The most common business debate isn't as black and white as you might think</a>
</div>
<div class="carousel-item">
<span class="badge bg-primary">Trending:</span>
<a href="#" class="text-light text-decoration-none">  How the 10 worst business fails of all time could have been prevented</a>
</div>
</div>
